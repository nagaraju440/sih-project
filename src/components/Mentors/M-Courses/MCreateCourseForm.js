...
function MCreateCourseForm() {
  ...
  const standard = ["beginner", "medium", "Advanced"];
...
>>>>>>> 0a1ccd9f5a7b00afc86da02bed01c035e654e5df
  ...
  return (
    <div className="MCreateCourseForm">
      ...
      <div className="MCreateCourseFormsheduleSecioon">
        <div className="MCreateCourseFormSheduleTitleSection">
          <div className="MCreateCourseFormSubTitle">
        ...
        <div>
          <ul>
            {dayWiseData.map((l, i) => {
              return (
                <div className="MCreateCourseFormSheduleCard">
                  <b className="MCreateCourseFormSheduleCardtext">Day {l.day} : </b> <span className="MCreateCourseFormSheduleCardtext"> {l.data}</span>
                </div>
              );
            })}
          </ul>
      ...
      <div className="MCreateCourseFormsheduleSecioon">
        ...
        >
          ...
          ></TextArea>
          <div className="MCreateCourseFormProjectCardBtn" onClick={AddProject}>
            Done
          </div>
        </Modal>
      </div>
      ...
      <div className="MCreateCourseFormCreateCourseBtn" onClick={onSubmitdata}>
        Create Course
      </div>
    </div>
  );
