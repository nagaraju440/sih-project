  ...
  return (
    <>
      ...
      <div className="MainContainer">
          ...
          <div className="right-section">
            <div>
              <div className="rs-heading-container">
                ...
                <h1 className="right-section-text">
                  <b style={{ color: "#004E89" }}>Teaching </b>is <br></br>to
                  learn <b style={{ color: "#004E89" }}>twice</b> over
                </h1>
              </div>
              ...
              <div className="Sc-right-section-button">
                <button
                  type="submit"
                  onClick={() => {
                    navigate("/mentorOrStudent_signup", {
        ...
        <div>
          <img src={Landingpage4} className="image2"></img>
        </div>
      </div>
